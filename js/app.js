let notes = [{
        title: "Carol's Party",
        text: 'Bring her a gift and buy soda. <div class="img-wp"><img src="./images/1.jpg" alt="" /></div> I\'m thinking of buying a really big gift because i wanna show all my love for her. Maybe a biiggg teddy bear would be perfect: <div class="img-wp"><img src="./images/3.jpg" alt="" /></div>',
        images: ["./images/1.jpg"],
    },
    {
        title: "Shopping List",
    ...
    },
    {
        ...
        text: 'Call Diego and tell him about the brunch. Brunch is a combination of breakfast and lunch, and regularly has some form of alcoholic drink (most usually champagne or a cocktail) served with it. It is usually served anytime before 3 o\'clock in the afternoon. <div class="img-wp"><img src="./images/2.jpg" alt="" /></div>',
        images: ["./images/2.jpg"],
    },
    {
        title: "Project Ideas",
